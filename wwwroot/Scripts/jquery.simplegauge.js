...
*/
        ...
        createAnalogBars: function () {
            ...
            this.$bars.html('');
            this.$bars.css({
                marginLeft: this.options.gaugeWidth / 2-1,
                marginTop: this.options.gaugeHeight / 2-1
            });
        ...
        createAnalogLabels: function () {
            this.$labels.css({
                marginLeft: this.options.gaugeWidth / 2+2,
                marginTop: this.options.gaugeHeight / 2+2
            });
